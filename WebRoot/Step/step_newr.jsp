...
<html>
        ...
        <div class="search">
           ...
           <%
              for(int i=1; i<=len;i++){
                ...
                <tr>
                <%
                for (int j = 0; j < data.get(Integer.toString(i)).size(); j++) {
                %>
                    <td><%=data.get(Integer.toString(i)).get(j)%></td>
                    <% 
                    } %>
                </tr>
  ...
  <script type="text/javascript">
    $(function(){
        ...
        url: "localhost:8080/Magic/Step/step_new.jsp",//改为当前网页的url，可通过鼠标右击网页 查看信息找出
        method: 'GET',                      //请求方式（*）
